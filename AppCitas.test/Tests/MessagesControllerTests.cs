...
namespace AppCitas.UnitTests.Pruebas
{
    public class MessagesControllerTests
    {
        ...
        [Theory]
        [InlineData("BadRequest", "lisa", "Pa$$w0rd", "lisa","hi")]
        ...
        [Theory]
        [InlineData("NotFound", "lisa", "Pa$$w0rd", "luismiguel", "Hi")]
        ...
        [Theory]
        [InlineData("OK", "tanner", "Pa$$w0rd", "lisa", "Hi")]
        ...
        [Theory]
        [InlineData("Unauthorized", "wagner", "Pa$$w0rd", "lisa", "Hi", "caroline")]
